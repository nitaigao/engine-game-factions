...
#ifndef __MemoryGlobalAlloc_H__
#define __MemoryGlobalAlloc_H__
...
namespace Ogre
{
#if OGRE_MEMORY_ALLOCATOR == OGRE_MEMORY_ALLOCATOR_GLOBAL
	...
	*/
	class _OgreExport GlobalAllocPolicy
	{
	public:
	...
	*/
	...
	class GlobalAlignedAllocPolicy
	{
	public:
