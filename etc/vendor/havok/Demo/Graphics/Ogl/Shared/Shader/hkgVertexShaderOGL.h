...
#ifndef HK_GRAPHICS_VERTEX_SHADER_OGL__H
#define HK_GRAPHICS_VERTEX_SHADER_OGL__H

#include <Graphics/Common/Shader/hkgShader.h>

class hkgVertexShaderOGL : public hkgShader
{
public:
		/// Create a blank, platform specific, shader object in the current context as given.
	static hkgShader* createVertexShaderOGL(hkgDisplayContext* context)
	{
		return new hkgVertexShaderOGL(context);
	}	
...
protected:		
	...
	hkgVertexShaderOGL(hkgDisplayContext* context);
	virtual ~hkgVertexShaderOGL();
...
#include <Graphics/Ogl/Shared/Shader/hkgVertexShaderOGL.inl>

#endif //HK_GRAPHICS_VERTEX_SHADER_OGL__H
