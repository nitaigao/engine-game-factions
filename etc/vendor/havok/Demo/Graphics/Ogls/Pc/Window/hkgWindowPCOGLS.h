...
#ifndef HK_GRAPHICS_WINDOW_PC_OGLS_H
#define HK_GRAPHICS_WINDOW_PC_OGLS_H

#include <Graphics/Ogls/Shared/Window/hkgWindowOGLS.h>


class hkgDirectJoystickPCOGLS;

class hkgWindowPCOGLS : public hkgWindowOGLS
{
	public:

		static hkgWindow* createWindowPCOGLS();
	...
	protected:
		...
		hkgWindowPCOGLS( HINSTANCE instance );
		virtual ~hkgWindowPCOGLS();
		...
		hkgDirectJoystickPCOGLS* m_directJoysticks[2];
};

// WndProc prototype
LRESULT CALLBACK hkgWindowProcOGLSPC(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam);

#include <Graphics/Ogls/Pc/Window/hkgWindowPCOGLS.inl>

#endif //HK_GRAPHICS_WINDOW_PC_OGLS_H
