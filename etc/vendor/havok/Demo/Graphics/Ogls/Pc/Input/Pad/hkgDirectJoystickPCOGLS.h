...
public:
	...
	HKG_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( hkgDirectJoystickPCOGLS );

	hkgDirectJoystickPCOGLS(HWND owner, LPDIRECTINPUTDEVICE8 device);
	~hkgDirectJoystickPCOGLS();

	static void createJoysticks( HWND owner, hkgDirectJoystickPCOGLS** joysticks, int numDesired, int& numCreated );
...
#include <Graphics/Ogls/Pc/Input/Pad/hkgDirectJoystickPCOGLS.inl>
