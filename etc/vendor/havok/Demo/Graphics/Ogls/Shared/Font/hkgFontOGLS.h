...
#ifndef HK_GRAPHICS_FONT_OGLS_H
#define HK_GRAPHICS_FONT_OGLS_H

#include <Graphics/Common/Font/hkgFont.h>

class hkgFontOGLS : public hkgFont
{
public:

	virtual void render(hkgDisplayContext* context, const char* text, float x, float y, float color[4] );
	
	static hkgFont* createFontOGLS() { return new hkgFontOGLS(); }
