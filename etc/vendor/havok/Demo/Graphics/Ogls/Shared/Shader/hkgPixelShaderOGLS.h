 ...
 * 
 */
#ifndef HK_GRAPHICS_PIXEL_SHADER_OGLS__H
#define HK_GRAPHICS_PIXEL_SHADER_OGLS__H

#include <Graphics/Common/Shader/hkgShader.h>

class hkgPixelShaderOGLS : public hkgShader
{
public:
		/// Create a blank, platform specific, shader object in the current context as given.
	static hkgShader* createPixelShaderOGLS(hkgDisplayContext* context)
	{
		return new hkgPixelShaderOGLS(context);
	}	
...
protected:		
	...
	hkgPixelShaderOGLS(hkgDisplayContext* context);
	virtual ~hkgPixelShaderOGLS();
...
#include <Graphics/Ogls/Shared/Shader/hkgPixelShaderOGLS.inl>

#endif //HK_GRAPHICS_PIXEL_SHADER_OGLS__H
