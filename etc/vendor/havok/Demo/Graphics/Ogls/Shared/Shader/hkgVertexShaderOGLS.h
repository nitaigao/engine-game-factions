 ...
 * 
 */
#ifndef HK_GRAPHICS_VERTEX_SHADER_OGLS__H
#define HK_GRAPHICS_VERTEX_SHADER_OGLS__H

#include <Graphics/Common/Shader/hkgShader.h>

class hkgVertexShaderOGLS : public hkgShader
{
public:
		/// Create a blank, platform specific, shader object in the current context as given.
	static hkgShader* createVertexShaderOGLS(hkgDisplayContext* context)
	{
		return new hkgVertexShaderOGLS(context);
	}	
...
protected:		
	...
	hkgVertexShaderOGLS(hkgDisplayContext* context);
	virtual ~hkgVertexShaderOGLS();
...
#include <Graphics/Ogls/Shared/Shader/hkgVertexShaderOGLS.inl>

#endif //HK_GRAPHICS_VERTEX_SHADER_OGLS__H
