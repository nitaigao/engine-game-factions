...
#ifndef HK_GRAPHICS_BLEND_MATRIX_SET_OGLS
#define HK_GRAPHICS_BLEND_MATRIX_SET_OGLS
...
class hkgBlendMatrixSetOGLS : public hkgBlendMatrixSet
{
public:
	
	static hkgBlendMatrixSet* createBlendMatrixSetOGLS(hkgDisplayContext* context)
	{
		return new hkgBlendMatrixSetOGLS(context);
	}	
...
protected:
	...
	hkgBlendMatrixSetOGLS(hkgDisplayContext* context);
...
#endif // HK_GRAPHICS_BLEND_MATRIX_SET_OGLS
