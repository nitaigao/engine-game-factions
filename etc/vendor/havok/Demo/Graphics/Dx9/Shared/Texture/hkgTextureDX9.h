...
#ifndef HK_GRAPHICS_TEXTURE_DX9_H
#define HK_GRAPHICS_TEXTURE_DX9_H

#include <Graphics/Common/Texture/hkgTexture.h>
#include <Graphics/Dx9/Shared/DisplayContext/hkgDisplayContextDX9.h>

class hkgTextureDX9 : public hkgTexture
{
public:

	static hkgTexture* createTextureDX9(hkgDisplayContext* context)
	{
		return new hkgTextureDX9(context);
	}	
...
protected:
	...
	unsigned m_ddsSize;
	inline hkgTextureDX9(hkgDisplayContext* context);
	virtual ~hkgTextureDX9();

};

#include <Graphics/Dx9/Shared/Texture/hkgTextureDX9.inl>

#endif // HK_GRAPHICS_TEXTURE_DX9_H
