...
#ifndef HK_GRAPHICS_VERTEX_SHADER_DX9_H
#define HK_GRAPHICS_VERTEX_SHADER_DX9_H

#include <Graphics/Common/Shader/hkgShader.h>

class hkgVertexShaderDX9 : public hkgShader
{
public:
		/// Create a blank, platform specific, shader object in the current context as given.
	static hkgShader* createVertexShaderDX9(hkgDisplayContext* context)
	{
		return new hkgVertexShaderDX9(context);
	}	
...
protected:		
	...
	inline hkgVertexShaderDX9(hkgDisplayContext* context);
	virtual ~hkgVertexShaderDX9();
...
#include <Graphics/Dx9/Shared/Shader/hkgVertexShaderDX9.inl>

#endif //HK_GRAPHICS_VERTEX_SHADER_DX9_H
