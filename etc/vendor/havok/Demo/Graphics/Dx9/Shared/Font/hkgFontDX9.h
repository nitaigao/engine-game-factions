...
#ifndef HK_GRAPHICS_FONT_DX9_H
#define HK_GRAPHICS_FONT_DX9_H

#include <Graphics/Common/Font/hkgFont.h>

class hkgFontDX9 : public hkgFont
{
public:

	static hkgFont* createFontDX9()
	{
		return new hkgFontDX9;
	}
