...
#ifndef HK_GRAPHICS_BLEND_MATRIX_SET_DX9
#define HK_GRAPHICS_BLEND_MATRIX_SET_DX9
...
class hkgBlendMatrixSetDX9 : public hkgBlendMatrixSet
{
public:
	
	static hkgBlendMatrixSet* createBlendMatrixSetDX9(hkgDisplayContext* context)
	{
		return new hkgBlendMatrixSetDX9(context);
	}	
...
protected:
	...
	hkgBlendMatrixSetDX9(hkgDisplayContext* context);
...
#endif // HK_GRAPHICS_BLEND_MATRIX_SET_DX9
