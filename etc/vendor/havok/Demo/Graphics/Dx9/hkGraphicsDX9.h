...
#ifndef HK_GRAPHICS_DX9_PRECOMPILE_H
#define HK_GRAPHICS_DX9_PRECOMPILE_H

#if defined(_XBOX)
// Note that we force the use of the fixed function pipe. This lib will be refactored to use shaders
// only in future releases.
#	define D3DCOMPILE_USEFIXEDFUNCTION 1
