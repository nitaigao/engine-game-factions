...
#ifndef HK_GRAPHICS_CAMERA_DX10_H
#define HK_GRAPHICS_CAMERA_DX10_H

#include <Graphics/Common/Camera/hkgCamera.h>

class hkgCameraDX10 : public hkgCamera
{
public:

	static hkgCamera* createCameraDX10();	
...
protected:
	...
	inline hkgCameraDX10( const float* from, const float* to, const float* up, float fov);
	virtual ~hkgCameraDX10() {}

	float m_platformView[16];
	float m_platformProj[16];
};

#include <Graphics/Dx10/Shared/Camera/hkgCameraDX10.inl>

#endif // HK_GRAPHICS_CAMERA_DX10_H
