...
#ifndef HK_GRAPHICS_PIXEL_SHADER_DX10_H
#define HK_GRAPHICS_PIXEL_SHADER_DX10_H

#include <Graphics/Dx10/Shared/Shader/hkgShaderDX10.h>

class hkgPixelShaderDX10 : public hkgShaderDX10
{
public:
		/// Create a blank, platform specific, shader object in the current context as given.
	static hkgShader* createPixelShaderDX10(hkgDisplayContext* context)
	{
		return new hkgPixelShaderDX10(context);
	}	
...
protected:		
	...
	inline hkgPixelShaderDX10(hkgDisplayContext* context);
	virtual ~hkgPixelShaderDX10();
		
	bool m_bound;
	ID3D10PixelShader* m_pixelShader;
};

#include <Graphics/Dx10/Shared/Shader/hkgPixelShaderDX10.inl>

#endif //HK_GRAPHICS_PIXEL_SHADER_DX10_H
