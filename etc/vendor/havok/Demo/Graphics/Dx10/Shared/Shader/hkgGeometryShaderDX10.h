...
#ifndef HK_GRAPHICS_GEOM_SHADER_DX10_H
#define HK_GRAPHICS_GEOM_SHADER_DX10_H

#include <Graphics/Dx10/Shared/Shader/hkgShaderDX10.h>

class hkgGeometryShaderDX10 : public hkgShaderDX10
{
public:
		/// Create a blank, platform specific, shader object in the current context as given.
	static hkgShader* createGeometryShaderDX10(hkgDisplayContext* context)
	{
		return new hkgGeometryShaderDX10(context);
	}	
...
protected:		
	...
	inline hkgGeometryShaderDX10(hkgDisplayContext* context);
	virtual ~hkgGeometryShaderDX10();
		
	bool m_bound;
	ID3D10GeometryShader* m_geomShader;
};

#include <Graphics/Dx10/Shared/Shader/hkgGeometryShaderDX10.inl>

#endif //HK_GRAPHICS_GEOM_SHADER_DX10_H
