...
#ifndef HK_GRAPHICS_VERTEX_SHADER_DX9S_H
#define HK_GRAPHICS_VERTEX_SHADER_DX9S_H

#include <Graphics/Common/Shader/hkgShader.h>

class hkgVertexShaderDX9S : public hkgShader
{
public:
		/// Create a blank, platform specific, shader object in the current context as given.
	static hkgShader* createVertexShaderDX9S(hkgDisplayContext* context)
	{
		return new hkgVertexShaderDX9S(context);
	}	
...
protected:		
	...
	inline hkgVertexShaderDX9S(hkgDisplayContext* context);
	virtual ~hkgVertexShaderDX9S();
...
#include <Graphics/Dx9s/Shared/Shader/hkgVertexShaderDX9S.inl>

#endif //HK_GRAPHICS_VERTEX_SHADER_DX9S_H
