...
#ifndef HK_GRAPHICS_SKINNED_INSTANCED_DISPLAY_OBJECT_DX9S__H
#define HK_GRAPHICS_SKINNED_INSTANCED_DISPLAY_OBJECT_DX9S__H
...
class hkgSkinnedInstancedDisplayObjectDX9S : public hkgSkinnedInstancedDisplayObject
{
	public:

		static hkgSkinnedInstancedDisplayObject* HK_CALL createSkinnedInstancedDisplayObjectDX9S( hkgDisplayContext* ctx );
	...
	protected:
		...
		inline hkgSkinnedInstancedDisplayObjectDX9S( hkgDisplayContextDX9S* ctx );
		virtual ~hkgSkinnedInstancedDisplayObjectDX9S();
...
#endif // HK_GRAPHICS_SKINNED_INSTANCED_DISPLAY_OBJECT_DX9S__H
