...
HkgSmokeParticleSystem::HkgEmitParams::HkgEmitParams()
	: m_minSpriteIndex(0),
	  m_maxSpriteIndex(0)
{
}

HkgSmokeParticleSystem::HkgSmokeParticleSystem( int randomSeed, hkDemoEnvironment* env,
	hkgMaterial* material, int maxNumParticlesDrawn, int particleStride )
	: SmokeParticleSystem(randomSeed, particleStride),
...
HkgSmokeParticleSystem::~HkgSmokeParticleSystem()
{
	m_demoEnvironment->m_window->getContext()->lock();
...
void HkgSmokeParticleSystem::clear()
{
...
void HkgSmokeParticleSystem::draw()
{
	m_demoEnvironment->m_window->getContext()->lock();
...
void HkgSmokeParticleSystem::initParticles(int numParticles, void* particleData, hkReal timestep, const void* emitParams)
{
	SmokeParticleSystem::initParticles(numParticles, particleData, timestep, emitParams);

	HK_ASSERT(0x5e351d5f, emitParams);
