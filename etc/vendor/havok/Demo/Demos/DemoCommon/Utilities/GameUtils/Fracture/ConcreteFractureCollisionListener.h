...
#ifndef CONCRETE_FRACTURE_LISTENER_H
#define CONCRETE_FRACTURE_LISTENER_H
...
class ConcreteFractureCollisionListener : public FractureCollisionListener
{
	public:
		...
		ConcreteFractureCollisionListener( hkArray<hkpRigidBody*>* outputArrayForFracturedBodies, hkReal fractureVelocity );
		...
		void createFracturedRigidBodyPieces(hkpWorld*             world, 
								  hkpRigidBody*         body, 
	...
	public:
		...
		int m_randomSeed;
			...
			/// Approximate crater diameter
		hkReal m_craterDiameter;
};

#endif // CONCRETE_FRACTURE_LISTENER_H
