...
class MonitorHelper: public hkReferencedObject
{
	public:
		...
		static void HK_CALL findAllNodesWithName ( const hkMonitorStreamAnalyzer::Node* root, const char* childName, hkArray<const hkMonitorStreamAnalyzer::Node*>& nodesOut );
