...
#ifndef BASICMOVEMENTDEMO_H
#define BASICMOVEMENTDEMO_H

#include <Demos/DemoCommon/DemoFramework/hkDefaultAnimationDemo.h>

#define NUM_ANIMS 3

class BasicMovementDemo : public hkDefaultAnimationDemo
{
	public:

		HK_DECLARE_CLASS_ALLOCATOR( HK_MEMORY_CLASS_DEMO );

		BasicMovementDemo( hkDemoEnvironment* env );
