...
#ifndef ATTACHMENTS_DEMO_H
#define ATTACHMENTS_DEMO_H

#include <Demos/DemoCommon/DemoFramework/hkDefaultAnimationDemo.h>

class AttachmentsDemo : public hkDefaultAnimationDemo
{
	public:

		HK_DECLARE_CLASS_ALLOCATOR( HK_MEMORY_CLASS_DEMO );

		AttachmentsDemo( hkDemoEnvironment* env );
	...
	private:
		...
		class hkaAnimationContainer* m_animContainer;
