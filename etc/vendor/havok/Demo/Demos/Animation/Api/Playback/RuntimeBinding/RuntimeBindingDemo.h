...
#ifndef RUNTIME_BINDING_DEMO_H
#define RUNTIME_BINDING_DEMO_H

#include <Demos/DemoCommon/DemoFramework/hkDefaultAnimationDemo.h>

class RuntimeBindingDemo : public hkDefaultAnimationDemo
{
	public:

		HK_DECLARE_CLASS_ALLOCATOR( HK_MEMORY_CLASS_DEMO );

		RuntimeBindingDemo( hkDemoEnvironment* env );
	...
	private:
		...
		class hkaAnimationBinding* m_runtimeBinding;
