...
#ifndef HK_MULTIPENDULUMS_H
#define HK_MULTIPENDULUMS_H
...
class MultiPendulumsDemo : public hkDefaultPhysicsDemo
{
	public:

		HK_DECLARE_CLASS_ALLOCATOR(HK_MEMORY_CLASS_DEMO);

		MultiPendulumsDemo(hkDemoEnvironment* env);
		~MultiPendulumsDemo();
		Result stepDemo(); 
