...
#ifndef HK_WorldLinearCastMultithreadingApiDemo_H
#define HK_WorldLinearCastMultithreadingApiDemo_H
...
class WorldLinearCastMultithreadingApiDemo  : public hkDefaultPhysicsDemo
{
	public:
		...
		HK_DECLARE_CLASS_ALLOCATOR( HK_MEMORY_CLASS_DEMO);
		 ...
		 WorldLinearCastMultithreadingApiDemo(hkDemoEnvironment* env);
		~WorldLinearCastMultithreadingApiDemo();
