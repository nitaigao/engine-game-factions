...
#ifndef SampledHeightFieldDemo_H
#define SampledHeightFieldDemo_H

#include <Demos/DemoCommon/DemoFramework/hkDefaultPhysicsDemo.h>


class SampledHeightFieldDemo : public hkDefaultPhysicsDemo
{
	public:

		HK_DECLARE_CLASS_ALLOCATOR(HK_MEMORY_CLASS_DEMO);

		SampledHeightFieldDemo(hkDemoEnvironment* env);
