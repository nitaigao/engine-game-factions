...
#ifndef HK_AddRemoveConstraintsDemo_H
#define HK_AddRemoveConstraintsDemo_H
...
class AddRemoveConstraintsDemo : public hkDefaultPhysicsDemo
{
	public:

		HK_DECLARE_CLASS_ALLOCATOR(HK_MEMORY_CLASS_DEMO);

		AddRemoveConstraintsDemo(hkDemoEnvironment* env);
...
#endif	// HK_AddRemoveConstraintsDemo_H
