...
#ifndef HK_UNARYACTIONAPI_H
#define HK_UNARYACTIONAPI_H

#include <Demos/DemoCommon/DemoFramework/hkDefaultPhysicsDemo.h>


class UnaryActionDemo : public hkDefaultPhysicsDemo
{
	public:
		UnaryActionDemo(hkDemoEnvironment* env);
};

#endif // HK_UNARYACTIONAPI_H
