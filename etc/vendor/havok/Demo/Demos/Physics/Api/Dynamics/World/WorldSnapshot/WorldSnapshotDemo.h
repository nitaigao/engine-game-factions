...
#ifndef HK_WorldSnapshotDemo_H
#define HK_WorldSnapshotDemo_H

#include <Demos/DemoCommon/DemoFramework/hkDefaultPhysicsDemo.h>
#include <Common/Serialize/Packfile/hkPackfileReader.h>


class WorldSnapshotDemo : public hkDefaultPhysicsDemo
{
	public:

		WorldSnapshotDemo( hkDemoEnvironment* env);
		WorldSnapshotDemo( hkDemoEnvironment* env, const char* startFile );
		~WorldSnapshotDemo();
