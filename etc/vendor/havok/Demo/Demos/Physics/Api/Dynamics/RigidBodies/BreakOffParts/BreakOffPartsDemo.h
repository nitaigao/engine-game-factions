...
#ifndef HK_BREAK_OFF_PARTS_DEMO_H
#define HK_BREAK_OFF_PARTS_DEMO_H
...
class hkpListShape;
	...
	/// A demo which tries to break off objects from a list shape
class BreakOffPartsDemo : public hkDefaultPhysicsDemo, public hkpBreakOffPartsListener
{
	public:
		HK_DECLARE_CLASS_ALLOCATOR(HK_MEMORY_CLASS_DEMO);

		BreakOffPartsDemo(hkDemoEnvironment* env);
...
#endif // HK_BREAK_OFF_PARTS_DEMO_H
