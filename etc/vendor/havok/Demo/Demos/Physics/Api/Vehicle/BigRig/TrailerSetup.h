...
#ifndef HK_TRAILER_SETUP_H
#define HK_TRAILER_SETUP_H

#include <Demos/Physics/Api/Vehicle/VehicleApi/VehicleSetup.h>

	/// This class holds ALL the vehicle parameters (hardcoded) for a big rig trailer
class TrailerSetup : public VehicleSetup
{
	public:
