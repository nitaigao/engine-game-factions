...
#ifndef HK_SIX_WHEEL_TRUCK_SETUP_H
#define HK_SIX_WHEEL_TRUCK_SETUP_H

#include <Demos/Physics/Api/Vehicle/VehicleApi/VehicleSetup.h>

	/// This class just holds ALL the vehicle parameters (hardcoded) for a six wheeled
	/// truck.
class SixWheelTruckSetup : public VehicleSetup
{
	public:
...
#endif // HK_SIX_WHEEL_TRUCK_SETUP_H
