...
#ifndef HK_TANK_SETUP_H
#define HK_TANK_SETUP_H

#include <Demos/Physics/Api/Vehicle/VehicleApi/VehicleSetup.h>

/// This class holds ALL the vehicle parameters (hardcoded) for a tank.
class TankSetup : public VehicleSetup
{
	public:
