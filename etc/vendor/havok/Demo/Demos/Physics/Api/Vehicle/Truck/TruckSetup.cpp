...
void TruckSetup::buildVehicle( const hkpWorld* world, hkpVehicleInstance& vehicle )
{
	//
...
void TruckSetup::setupVehicleData( const hkpWorld* world, hkpVehicleData& data )
{
...
void TruckSetup::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultAnalogDriverInput& driverInput )
{
...
void TruckSetup::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultSteering& steering )
{   
...
void TruckSetup::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultEngine& engine )
{
...
void TruckSetup::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultTransmission& transmission )
{
	int numGears = 4;
...
void TruckSetup::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultSuspension& suspension ) 
{
	suspension.m_wheelParams.setSize( data.m_numWheels );
	suspension.m_wheelSpringParams.setSize( data.m_numWheels );

	hkReal wheelsLength = 0.45f;
...
void TruckSetup::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultAerodynamics& aerodynamics ) 
{
...
void TruckSetup::setupComponent( const hkpVehicleData& data, hkpVehicleDefaultVelocityDamper& velocityDamper )
{
...
void TruckSetup::setupTyremarks( const hkpVehicleData& data, hkpTyremarksInfo& tyreMarks ) 
{
