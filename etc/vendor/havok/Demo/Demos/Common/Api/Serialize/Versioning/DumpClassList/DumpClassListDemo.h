...
#ifndef HK_DUMPCLASSLIST_H
#define HK_DUMPCLASSLIST_H
...
class DumpClassListDemo : public hkDefaultDemo
{
	public:

		DumpClassListDemo( hkDemoEnvironment* env);

		Result stepDemo();
};

#endif // HK_DUMPCLASSLIST_H
