...
//:STYLE VertOneLightDoubleBumpT2 PixT2DoubleBumpNS LD1 T2 DIFFUSE0 NORMAL0 NORMAL1
//:STYLE VertOneLightDoubleBumpShadowProjT2 PixShadowSceneT2DoubleBumpNS LD1 T2 SHADOWMAP DIFFUSE0 NORMAL0 NORMAL1

//:STYLE VertOneLightDoubleBumpT2 PixT2DoubleBump LD2 T2 DIFFUSE0 NORMAL0 NORMAL1 SPECULAR0
//:STYLE VertOneLightDoubleBumpShadowProjT2 PixShadowSceneT2DoubleBump LD2 T2 SHADOWMAP DIFFUSE0 NORMAL0 NORMAL1 SPECULAR0

//:STYLE VertOneLightDoubleBumpT2 PixT2DoubleBumpNS LD2 T2 DIFFUSE0 NORMAL0 NORMAL1
//:STYLE VertOneLightDoubleBumpShadowProjT2 PixShadowSceneT2DoubleBumpNS LD2 T2 SHADOWMAP DIFFUSE0 NORMAL0 NORMAL1

//:STYLE VertOneLightDoubleBumpT2 PixT2DoubleBump LD1 T2 DIFFUSE0 NORMAL0 NORMAL1 SPECULAR0 INSTANCED DEFINE:HKG_INSTANCING
//:STYLE VertOneLightDoubleBumpShadowProjT2 PixShadowSceneT2DoubleBump LD1 T2 SHADOWMAP DIFFUSE0 NORMAL0 NORMAL1 SPECULAR0 INSTANCED DEFINE:HKG_INSTANCING

//:STYLE VertOneLightDoubleBumpT2 PixT2DoubleBumpNS LD1 T2 DIFFUSE0 NORMAL0 NORMAL1 INSTANCED DEFINE:HKG_INSTANCING
//:STYLE VertOneLightDoubleBumpShadowProjT2 PixShadowSceneT2DoubleBumpNS LD1 T2 SHADOWMAP DIFFUSE0 NORMAL0 NORMAL1 INSTANCED DEFINE:HKG_INSTANCING

//:STYLE VertOneLightDoubleBumpT2 PixT2DoubleBump LD2 T2 DIFFUSE0 NORMAL0 NORMAL1 SPECULAR0 INSTANCED DEFINE:HKG_INSTANCING
//:STYLE VertOneLightDoubleBumpShadowProjT2 PixShadowSceneT2DoubleBump LD2 T2 SHADOWMAP DIFFUSE0 NORMAL0 NORMAL1 SPECULAR0 INSTANCED DEFINE:HKG_INSTANCING

//:STYLE VertOneLightDoubleBumpT2 PixT2DoubleBumpNS LD2 T2 DIFFUSE0 NORMAL0 NORMAL1 INSTANCED DEFINE:HKG_INSTANCING
//:STYLE VertOneLightDoubleBumpShadowProjT2 PixShadowSceneT2DoubleBumpNS LD2 T2 SHADOWMAP DIFFUSE0 NORMAL0 NORMAL1 INSTANCED DEFINE:HKG_INSTANCING
...
vertexOutputT2B VertOneLightDoubleBumpT2( vertexInputT2B In )
{
	...
	// light vector
	float3 L0 = mul( objToTangentSpace, lightVec ); // transform from object to tangent space
	float3 L1 = 0;
	if (g_iNumLights > 1)
	{
	...
	// eye vector
	float3 e = mul(objToTangentSpace, eyeVec );	// transform to tangent space
...
pixelOutput PixT2DoubleBump( vertexOutputT2B In )
{
	...
	float3 N0 = _sample1(In.texCoord0).xyz*4.0 - 2.0;
	float3 N1 = _sample2(In.texCoord1).xyz*2.0 - 1.0;
	N = normalize(N0+N1);
#endif
...
pixelOutput PixT2DoubleBumpNS( vertexOutputT2B In )
{
	...
	pixelOutput Output;
	Output.color.rgb = negLight*g_cAmbientColor.rgb*ColorMap.rgb + totalLight*ColorMap.rgb + light0.www*g_cSpecularColor;
	Output.color.a = ColorMap.a; // modulate alpha as is, light doesn't affect it.
	if ( g_iFogParams.x > 0)
    {
		Output.color = computeFog( In.posView.z, Output.color );
...
pixelOutput PixShadowSceneT2DoubleBumpNS( vertexOutputShadowT2B In )
{
    pixelOutput Output;
