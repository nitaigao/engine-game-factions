...
//:STYLE VertOneLightTransT1 PixT1Trans LD2 T1 DIFFUSE0 NORMAL0 SPECULAR0 SPECULAR0 OPACITY0
//:STYLE VertOneLightTransShadowProjT1 PixShadowSceneT1Trans LD2 T1 SHADOWMAP DIFFUSE0 NORMAL0 SPECULAR0 SPECULAR0 OPACITY0

//:STYLE VertOneLightTransT1 PixT1Trans LD1 T1 DIFFUSE0 NORMAL0 SPECULAR0 SPECULAR0 OPACITY0 INSTANCED DEFINE:HKG_INSTANCING
//:STYLE VertOneLightTransShadowProjT1 PixShadowSceneT1Trans LD1 T1 SHADOWMAP DIFFUSE0 NORMAL0 SPECULAR0 SPECULAR0 OPACITY0 INSTANCED DEFINE:HKG_INSTANCING
//:STYLE VertOneLightTransT1 PixT1Trans LD2 T1 DIFFUSE0 NORMAL0 SPECULAR0 SPECULAR0 OPACITY0 INSTANCED DEFINE:HKG_INSTANCING
//:STYLE VertOneLightTransShadowProjT1 PixShadowSceneT1Trans LD2 T1 SHADOWMAP DIFFUSE0 NORMAL0 SPECULAR0 SPECULAR0 OPACITY0 INSTANCED DEFINE:HKG_INSTANCING
...
pixelOutput PixShadowSceneT1Trans( vertexOutputShadowT1B In )
{
	...
	float4 OpacityMap = tex2D(g_sSamplerSeven, In.texCoord0);
	float Opacity = OpacityMap.a; //((OpacityMap.r + OpacityMap.g + OpacityMap.b) / 3);
	clip( Opacity*ColorMap.a - ALPHA_DISCARD_TOLERANCE );
