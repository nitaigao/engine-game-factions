...
void GdcJumpState::enterState( hkUint32 prevState, GdcAnimationMachine* animMachine ) const
{
...
void GdcJumpState::leaveState( hkUint32 nextState, GdcAnimationMachine* animMachine ) const
{
	GdcAnimationMachine::AnimationCommand cmd;
	cmd.m_time = 0.0f; // immediately
...
void GdcJumpState::update( hkReal timestep, const GdcStateInput* input ) const
{
