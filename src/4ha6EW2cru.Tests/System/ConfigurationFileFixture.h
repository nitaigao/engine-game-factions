...
class ConfigurationFileFixture : public CPPUNIT_NS::TestFixture
{
  ...
  CPPUNIT_TEST( Should_Find_Default_Config_Item_On_FindConfigItemInt );
  CPPUNIT_TEST( Should_Find_Default_Config_Item_On_FindConfigItemString );
  CPPUNIT_TEST( Should_Find_Default_Config_Item_On_FindConfigItemBool );
  CPPUNIT_TEST( Should_Find_Stored_Config_Item_On_FindConfigItemBool );
...
private:
  ...
  void Should_Find_Default_Config_Item_On_FindConfigItemInt( );
  void Should_Find_Default_Config_Item_On_FindConfigItemString( );
  void Should_Find_Default_Config_Item_On_FindConfigItemBool( );
  void Should_Find_Stored_Config_Item_On_FindConfigItemBool( );
